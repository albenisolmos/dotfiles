...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  call <sid>X('ErrorMsg',     s:hue_5,         s:syntax_bg,      'italic')
  ...
  call <sid>X('WarningMsg',   s:hue_5,         '',               'none')
  ...
  call <sid>X('String',         s:hue_4,         '',          'italic')
